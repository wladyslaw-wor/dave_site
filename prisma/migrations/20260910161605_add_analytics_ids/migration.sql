...
INSERT INTO "new_Content" ("aboutPhoto", "aboutText", "aboutTitle", "accent", "avatarUrl", "bgUrl", "bio", "contactLabel", "contactUrl", "coverUrl", "font", "footer", "id", "kicker", "layout", "name", "overlay", "releaseKicker", "releaseTitle", "releaseUrl", "showTour", "updatedAt", "videoUrl") SELECT "aboutPhoto", "aboutText", "aboutTitle", "accent", "avatarUrl", "bgUrl", "bio", "contactLabel", "contactUrl", "coverUrl", "font", "footer", "id", "kicker", "layout", "name", "overlay", "releaseKicker", "releaseTitle", "releaseUrl", "showTour", "updatedAt", "videoUrl" FROM "Content";
DROP TABLE "Content";
