...
export type UploadCategory = "video" | "bg" | "avatar" | "cover" | "press" | "album" | "blog" | "archive";
...
export const UPLOAD_CATEGORIES: UploadCategory[] = ["video", "bg", "avatar", "cover", "press", "album", "blog", "archive"];
